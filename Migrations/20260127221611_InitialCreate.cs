        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayoutDetails = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    BillingCountry = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ZipCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    IdImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    SelfieImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ResidenceProofImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    JobProofImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarLicenseImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderPaymentId = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ProviderReceiptUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
